...
public class MazeFogView {
  public static void draw(Graphics g, int width, int height) {
    ...
    Ellipse2D.Float inner2 = new Ellipse2D.Float(x2, y2, width / 2f - 100, height / 2f - 100);
    ...
    Ellipse2D.Float inner3 = new Ellipse2D.Float(x3, y3, width / 2f - 200, height / 2f - 200);
    ...
    Ellipse2D.Float inner4 = new Ellipse2D.Float(x4, y4, width / 2f - 300, height / 2f - 300);
    ...
    Ellipse2D.Float inner5 = new Ellipse2D.Float(x5, y5, width / 2f - 400, height / 2f - 400);
